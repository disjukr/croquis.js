...
xpop.croquis.paintingtool = xpop.croquis.paintingtool || {};
xpop.croquis.paintingtool.Brush = function (canvasRenderingContext)
{
	...
	var color = new xpop.croquis.Color(0, 0, 0, 1);
